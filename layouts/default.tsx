...
import Header_notification from "@/components/LandingPage/header/index";
...
export default function DefaultLayout({
	...
	return (
		<div className="relative flex flex-col h-screen">
			...
			<footer className="p-4 sm:p-6 border-t mt-16">
				<div className="mx-auto max-w-screen-xl">
					...
					<div className="sm:flex sm:items-center sm:justify-between">
						<span className="text-sm sm:text-center">© 2024 <a href="https://openpe.com" className="hover:underline">OpenPe</a>. All Rights Reserved.
						</span>
